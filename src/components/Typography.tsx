      ...
      <div className="max-w-7xl mx-auto px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-300 font-sans max-w-2xl mx-auto">
            Powerful visuals start with powerful words. <br/>
            I use typography to build clarity, hierarchy, and identity across every piece of content.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-lg text-gray-300 leading-relaxed font-sans">
            To help brands communicate with precision and elegance through design systems that match global industry standards.
          </p>
        </motion.div>
