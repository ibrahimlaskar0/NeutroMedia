      ...
      >
        {gradient && (
          <div className="absolute top-0 isolate z-0 flex w-screen flex-1 items-start justify-center">
            ...
            {/* Main glow */}
            <div className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-[-30%] rounded-full bg-gradient-to-r from-purple-500/60 to-pink-500/60 opacity-80 blur-3xl" />
            ...
            <motion.div
              ...
              className="absolute top-0 z-30 h-36 -translate-y-[20%] rounded-full bg-gradient-to-r from-purple-500/60 to-pink-500/60 blur-2xl"
            />
            ...
            <motion.div
              ...
              className="absolute inset-auto z-50 h-0.5 -translate-y-[-10%] bg-gradient-to-r from-purple-500/60 to-pink-500/60"
            />
